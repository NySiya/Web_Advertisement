function InnityAutoSpanGenerator(callback) {
    var articleLocator = (function() {
        ...
        function bo(e) {
            ...
            return aF.bc.push(e), !aF.cV && !aF.cR ? (e.bh = t, e.bh) : (e.bh = {
                top: t.top + aF.cR,
                right: t.right + aF.cV,
                bottom: t.bottom + aF.cR,
                left: t.left + aF.cV,
                width: t.width,
                height: t.height
            }, e.bh)
        ...
        function aH(e, t) {
            ...
            return n ? (n - aE(e, t)) / n : 0
        };

        function bk(e, t) {
            return e === t ? !0 : aH(e, t) > bE
        };
        ...
        function aI(e) {
            ...
            var t = Math.min(e.length, aw),
                n = 0,
                r = 0;
            for (var i = 0; i < t; i++) {
                var s = e[i].nodeValue.trim(),
                    o = Math.min(s.length, aT);
                for (var u = 0; u < o; u++) ap(s[u]) && n++;
                r += o
            }
            return n >= r * bs ? aC : 1
        };
        ...
        function al(e) {
            ...
            for (var n = e; n; n = n.parentElement) {
                ...
                r && (cw.test(r) && (t += dp), ck.test(r) && (t -= dm));
                var i = n.className;
                i && (cw.test(i) && (t += dp), ck.test(i) && (t -= dm)), n.tagName === "ARTICLE" && (t += dp)
            }
            return t < 0 ? 0 : t
        };

        function aj(e, t) {
            if (typeof aD != "undefined" && aD.cl) {
                var n = aD.cl(e, t);
        ...
        function aL(e) {
            return typeof aD != "undefined" && aD.aL ? aD.aL(e) : e
        };
        ...
        function bp(e, t) {
            function s(e, t) {
                ...
                if (a && t > 0) {
                    o.push(n);
                    for (var f = 0; f < a; ++f) o.push(s(u[f], t - 1)), f !== a - 1 && o.push(i);
                    o.push(r)
                }
                return o.join("")
            };
        ...
        var ds = 1600,
            ...
            ck = /comment|meta|footer|footnote/,
            dm = .75,
            cw = /(?:(?:^|\s)(?:(post|hentry|entry)[-_]?(?:content|text|body)?|article[-_]?(?:content|text|body|page)?)(?:\s|$))/i,
            dp = .5,
            cU = "#disqus_thread, #comments, .userComments",
            dg = /^on|^id$|^class$|^style$/,
            bY = /article|body|content|entry|hentry|page|pagination|post|text/i,
            cf = /advertisement|breadcrumb|combx|comment|contact|disqus|footer|link|meta|mod-conversations|promo|related|scroll|share|shoutbox|sidebar|social|sponsor|tags|toolbox|widget/i,
            ae = /instapaper_body/,
            dJ = /instapaper_ignore/,
            bv = 200,
            au = 200,
            ai = .1,
            aw = 3,
            ...
            bg = 200,
            bx = 150,
            de = "descendant-or-self::*[(not(@id) or (@id!='disqus_thread' and @id!='comments')) and (not(@class) or @class!='userComments')]/a",
            eN = /\D(?:\d\d(?:\d\d)?[\-\/](?:10|11|12|0?[1-9])[\-\/](?:30|31|[12][0-9]|0?[1-9])|\d\d(?:\d\d)?\/(?:10|11|12|0[1-9])|(?:10|11|12|0?[1-9])\-(?:30|31|[12][0-9]|0?[1-9])\-\d\d(?:\d\d)?|(?:30|31|[12][0-9]|0?[1-9])\-(?:10|11|12|0?[1-9])\-\d\d(?:\d\d)?)\D/,
            aO = /(page|^p$|^pg$)/i,
            bA = /\/.*page.*\/\d+/i,
            cD = /\/\d+\/?$/,
            bP = /archives?\/\d+\/?$/,
            bN = /author|comment|feed|id|related/i,
            dG = 100,
            ca = .75,
            az = 200,
            ac = .75,
            ...
            bE = .97;
        db = function(e, t) {
            this.element = e, this.contentDocument = t, this.ce = this.cz(this.element), this.cB = this.dF(), this.bS = this.bu(), this.aS = 0, this.dz = 0
        }, db.am = function(t, n, r, i) {
            var s = "a, b, strong, i, em, u, span";
            var o = bo(t),
                u = bo(n.element);
            if (i && o.height < aM || !i && o.height < be)
                if (t.childElementCount && t.querySelectorAll("*").length !== t.querySelectorAll(s).length) return null;
            if (i) {
            ...
            var f = .1 * u.width;
            if (Math.abs(o.left - u.left) > f || Math.abs(o.right - n.right) > f) return null;
            var l = new db(t, r);
            return l.eA = i, l
        }, db.bI = function(t, n, r) {
            var i = bo(t);
            return i.width < ba || i.height < ax ? null : i.width * i.height < cX ? null : !r && i.top > cG ? null : db.aa(t) < ax ? null : new db(t, n)
        }, db.aa = function(t) {
            var n = bo(t),
                r = n.height,
            ...
            for (var o = 0; o < l; ++o) {
                var h = f[o];
                if (c && c.compareDocumentPosition(h) & dO) continue;
                ...
                v.width > n.width * aY && m / y < aU && (r -= v.height, c = h)
            }
            return r
        }, db.prototype = {
            dF: function() {
                var t = 0,
                    n = this.ce,
                    r = n.length;
                for (var i = 0; i < r; ++i) t += this.cY(n[i]);
                return t
            },
            bu: function() {
                return al(this.element)
            },
            ab: function() {
                if (this.aS !== 0) return;
                this.aS = aI(this.ce)
            ...
            cW: function() {
                return this.dz || (this.dz = aq(this.element)), this.dz
            },
            cC: function() {
                return this.ab(), this.dc() * this.aS
            },
            dc: function() {
                return this.cB * this.bS
            },
            cq: function() {
                var t = 0,
                    n = this.element.querySelector(cU);
                n && (t = n.clientWidth * n.clientHeight);
                var r = this.element.children,
                    i = r.length;
                for (var s = 0; s < i; ++s) {
                    var o = r[s];
                    aA(o) && (t += o.clientWidth * o.clientHeight)
                }
                var u = bo(this.element).width * bo(this.element).height,
                    a = u * bM,
                    f = bo(this.element).width * aQ,
                    l = this.element.querySelectorAll("img, object, video"),
                    c = l.length;
                for (var s = 0; s < c; ++s) {
                    var h = bo(l[s]);
                    if (h.width >= f && h.height > dr) {
                ...
                var d = this.dc(),
                    ...
                    y = 0;
                for (var s = 0; s < m; ++s) {
                    var b = this.ce[s].parentNode;
                    b && (y += ag(getComputedStyle(b)), g++)
                }
                var w = dv;
                return g && (w = y /= g), this.ab(), d / v * 1e3 * (w / dv) * this.aS
            },
            cz: function(t) {
                var n = [];
                if (!t) return n;
                ...
                var i = this.contentDocument,
                    s = function(e) {
                        var t = "text()|*/text()|*/a/text()|*/li/text()|*/span/text()|*/em/text()|*/i/text()|*/strong/text()|*/b/text()|*/font/text()|blockquote/*/text()|div[count(./p)=count(./*)]/p/text()";
                        var s = i.evaluate(t, e, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null),
                            o = s.snapshotLength;
                        for (var u = 0; u < o; ++u) {
                            var a = s.snapshotItem(u);
                            if (r[a.parentNode.tagName] || a.bW || bm(a)) continue;
                            a.bW = !0, n.push(a)
                        }
                    };
                s(t);
                ...
                var l = n.length;
                for (var a = 0; a < l; ++a) delete n[a].bW;
                return n
            },
            ar: function(t) {
                var n = this.ce.length;
                for (var r = 0; r < n; ++r) this.ce[r].cK = !0;
                var i = t.ce,
                    s = i.length;
                for (var r = 0; r < s; ++r) i[r].cK || this.ce.push(i[r]);
                var n = this.ce.length;
                for (var r = 0; r < n; ++r) this.ce[r].cK = null;
                this.cB = this.dF()
            },
            cY: function(t) {
                var n = 20;
                ...
                if (!bG(i)) return 0;
                var s = 1;
                while (i && i !== this.element) s -= .1, i = i.parentNode;
                return Math.pow(r * s, aB)
            },
            bF: function() {
                return this.cq() < dB ? !0 : !1
            },
            aG: function() {
            ...
            bC: function(t) {
                ...
                function s(e, t) {
                    if (!e || !t) return !1;
                    var n = 1;
                    return e.className ? e.className === t.className : bp(e, n) === bp(t, n)
                };
                var n = /clearfix/i,
                    r = "h1, h2, h3, h4, h5, h6";
                var o = this.element;
                if (o.tagName === "LI" || o.tagName === "DD") {
                    ...
                    for (var f = 0; f < a; ++f) {
                        var l = u.children[f];
                        if (l.tagName === o.tagName && l.className === o.className && l !== o) return !0
                    }
                }
                ...
                if (c) {
                    t || (t = []);
                    var h = t.length;
                    for (var f = 0; f < h; ++f) t[f].element.dq = t[f];
                    var p;
                    try {
                        var d = c.split(" "),
                            v = "";
                    ...
                    for (var f = 0; f < b; ++f) {
                        ...
                        var w = l.dq;
                        if (!w) {
                            w = new db(l, this.contentDocument);
                            if (!w) continue
                        }
                        if (w.dc() * cN > this.dc()) {
                            if (!g && bo(l).bottom < bo(this.element).top) {
                                g = !0;
                                continue
                            }
                            ...
                            while (o.childElementCount <= 1) {
                                ...
                                if (o.firstElementChild.tagName !== l.firstElementChild.tagName) return !1;
                            ...
                            if (N.length || k.length) {
                                ...
                                if (N === k && o.querySelectorAll("." + k.replace(/\s+/, ".")).length <= A) return !0
                            }
                            if (C.length || L.length) {
                                if (!C.length || !L.length) return !1;
                                if (C === L && o.querySelectorAll("." + L.replace(/\s+/, ".")).length <= A) return !0
                            }
                    ...
                    for (var f = 0; f < h; ++f) t[f].element.dq = null
                }
                return !1
            },
            cP: function() {
        ...
        }, String.prototype.dM = function(e) {
            var t = !1,
                n = e.length;
            for (var r = 0; r < n; ++r)
            ...
            var i = "",
                s = this.length;
            for (var r = 0; r < s; ++r) e.indexOf(this.charAt(r)) !== -1 && (i += "\\"), i += this.charAt(r);
            return i
        }, String.prototype.eD = function() {
            return this.dM("^[]{}()\\.$*+?|")
        }, top.Element.prototype.aJ = function() {
            var e = this.children;
            if (!e) return [];
            var t = e.length;
            if (!t) return [];
            ...
            for (var r = 0; r < t; ++r) {
                var i = e[r];
                if (bw[i.tagName] || !i.className) continue;
                var s = i.classList,
                    o = s.length;
                for (var u = 0; u < o; ++u) {
                    var a = s[u],
            ...
            this.contentDocument = e, this.ay = !1, this.article = null, this.cs = !1, this.ez = null, this.eP = null, this.cR = 0, this.cV = 0, this.bc = [], this.bO = null, this.dC = 1, this.dk = null, this.bb = [], this.af = []
        }, bf.prototype = {
            df: function() {
                return this.cF() ? this.cE() ? !0 : (this.dw(), this.article = this.as(), this.article && this.cb(), !!this.article) : null
            },
            aR: function() {
                var e = /(.*page.*)(\d{1,2})(.*)/i,
                    t = 3;
                ...
                for (var a = 0; a < u; ++a) {
                    ...
                    if (bG(f) && !bn(f)) continue;
                    n.push(f)
                }
                return n
            },
            ak: function() {
                return this.aR().map(function(e) {
                    return this.cp(e, e.cloneNode(!0), !1)
                }, this)
            },
            bB: function(t) {
                return t ? !(t.toLowerCase() in di) : !1
            },
            aN: function(t) {
            ...
            ff: function() {
                ...
                while (n) {
                    ...
                    i && (r.id = i), this.bB(n.className) && (r.className = n.className), r.index = 1;
                    for (var s = n.previousElementSibling; s; s = s.previousElementSibling) this.aN(s) || r.index++;
            ...
            cL: function(t) {
                ...
                while (n = n.parentElement)
                    if (ae.test(n.className)) {
                        this.article.element = n;
                        return
                    }
                n = this.article.element;
                if (n.getAttribute("id") || !n.className) return;
                var r = n.tagName,
                    i = n.className,
                    s = n.parentElement,
                    o = s.children;
                for (var u = 0, a = o.length; u < a; ++u) {
                    var f = o[u];
                    if (f === n) continue;
                    if (f.tagName !== r || f.className !== i) continue;
                    var l = db.bI(f, this.contentDocument, !0);
                    if (!l || l.cC() < ds) continue;
                    this.article.element = s;
                    return
                }
            },
            articleNode: function(t) {
                return this.ay || (this.article || (this.article = this.bU()), this.article || (this.article = this.as()), !this.article && t && (this.article = this.bU(!0)), this.ay = !0, this.article && this.cb()), this.cL(), this.article ? this.article.element : null
            },
            ek: function() {
                return null
            },
            dw: function() {
                this.cR = window.scrollY, this.cV = window.scrollX
            },
            es: function() {
                return this.bO ? this.bO : (this.bO = bL(this.contentDocument, this.articleNode()), this.bO || (this.bO = getComputedStyle(this.articleNode())), this.bO)
            },
            cZ: function(t, n) {
                var r = 0,
                    i = t.textContent,
            ...
            dA: function(t) {
                var n = bd(t.textContent).length;
                if (!n) return 0;
                var r = t.getElementsByTagName("a"),
                    i = 0,
                    s = r.length;
                for (var o = 0; o < s; ++o) i += bd(r[o].textContent).length;
                return i / n
            },
            dn: function(t, n) {
                var r = .33,
                ...
                if (t.tagName === "IFRAME") return !a.test(aK(t.src, this.contentDocument).hostname);
                if (t.tagName !== "OBJECT" && t.tagName !== "EMBED" && t.tagName !== "CANVAS") {
                    ...
                    for (var c = 0; c < l; ++c) {
                        var h = t.childNodes[c],
                            p = h.nodeType;
                        if (p === Node.ELEMENT_NODE || p === Node.TEXT_NODE && !bm(h)) {
                            f = !0;
                            break
                        }
                    }
                    if (!f) {
                        if (t.tagName === "P") {
                            var d = t.previousSibling,
                                v = t.nextSibling;
                            if (d && d.nodeType === Node.TEXT_NODE && !bm(d) && v && v.nodeType === Node.TEXT_NODE && !bm(v)) return !1
                        }
                        return !0
                    }
                    if (t.tagName === "P") return !1
                }
                if (t.tagName === "CANVAS") return t.parentNode.tagName === "CUFON";
                var m = 0;
                if (n) {
                    if (dJ.test(n.className)) return !0;
                    var g = n.className,
                        y = n.getAttribute("id");
                    bY.test(g) && m++, bY.test(y) && m++, cf.test(g) && m--, cf.test(y) && m--
                }
                if (m < 0) return !0;
                if (t.tagName === "UL") return n.querySelector("iframe") && n.querySelector("script") ? !0 : !1;
                if (t.tagName === "OBJECT") {
                    var b = t.querySelector("embed[src]"),
                        w = b ? aK(b.src, this.contentDocument) : null;
                    if (w && a.test(w.hostname)) return !1;
                    var E = t.getAttribute("data");
                    return w = E ? aK(E, this.contentDocument) : null, w && a.test(w.hostname) ? !1 : !0
                }
                if (t.childElementCount === 1) {
                    var S = t.firstElementChild;
                    if (S.tagName === "A") return !1;
                    if (S.tagName === "SPAN" && S.className === "converted-anchor" && aP(S, "TABLE")) return !1
                }
                ...
                if (!this.cZ(t, 10)) return !1;
                var L = t.getElementsByTagName("p").length,
                    A = t.getElementsByTagName("br").length,
                    O = L + Math.floor(A / 2);
                if (T > O) return !0;
                if (t.getElementsByTagName("li").length > O) return !0;
                if (t.getElementsByTagName("input").length / O > r) return !0;
                if (t.textContent.length < o && T !== 1) return !0;
                if (t.querySelector("embed")) return !0;
                var M = this.dA(t);
                if (m >= 1 && M > i) return !0;
                if (m < 1 && M > s) return !0;
                if (t.tagName === "TABLE") {
                    var _ = bd(t.innerText).length,
                        D = bd(n.innerText).length;
                    if (_ <= D * .5) return !0
                }
                return !1
            },
            ...
            cT: function(t) {
                return !this.article || !t ? !1 : t.getBoundingClientRect().width >= this.article.element.getBoundingClientRect().width - bD
            },
            eJ: function(t) {
            ...
            cp: function(t, n, r) {
                ...
                var a = [],
                    ...
                    k = T(),
                    L = new Set;
                this.af.forEach(function(e) {
                    L.add(e)
                });
                while (d) {
                    var O = null,
                        M = m.tagName;
                    m.bX = d, d === b && (w = m), M in i && (O = m), !O && d === y && (O = m);
                    if (!O && (M === "H1" || M === "H2")) {
                    ...
                    if (!O && M === "DIV" && m.parentNode) {
                        ...
                        if (!j && !B.length) {
                            ...
                            F.replaceChild(I, m), w === m && (w = I), m = I, m.bX = d, M = m.tagName
                        }
                    ...
                    if (!O) {
                        if (E) {
                            ...
                            if (R) {
                                var U = C ? f === 1 && av(d) === C : !1;
                                U || (O = m)
                            }
                        }
                        bn(d) ? O = m : d !== t && !l && H["float"] !== "none" && !k && (bo(d).height >= cI || d.childElementCount > 1) && (l = 1)
                    }
                    if (!O) {
                        var z = m.attributes;
                        for (var W = 0; W < z.length; ++W) {
                            var X = z[W].nodeName;
                            dg.test(X) && (m.removeAttribute(X), W--)
                        }
                        ...
                        if (l) {
                            l === 1 && (bo(d).width <= cJ ? m.setAttribute("class", "auxiliary float " + H["float"]) : m.classList.add("auxiliary"));
                            ...
                            l === 1 && !Q && (m.style.width = bo(d).width + "px");
                        ...
                        if (M === "TABLE") c || (c = 1);
                            ...
                            if (st === "left" || st === "right") m.classList.add("float"), m.classList.add(st);
                            if (!l && !rt) {
                                var ot = bo(d),
                                    ut = ot.width,
                                    at = ot.height;
                                ut === 1 && at === 1 ? O = m : ut < bZ && at < bZ && m.setAttribute("class", "reader-image-tiny")
                            }
                        } else if (M === "FONT") m.removeAttribute("size"), m.removeAttribute("face"), m.removeAttribute("color");
                            ...
                            if (ft && ft.length && (ft[0] === "#" || ft.substring(0, 11) === "javascript:")) {
                                ...
                                if (!O) {
                                    ...
                                    if (m.childElementCount === 1 && m.firstElementChild.tagName === "IMG") {
                                        ...
                                        ct.width > cg && ct.height > dQ && I.setAttribute("class", "converted-image-anchor")
                                    }
                                    I.className || I.setAttribute("class", "converted-anchor");
                                    while (m.firstChild) I.appendChild(m.firstChild);
                    ...
                    if (!O && M === "A" && L.has(d.href)) {
                        ...
                        while ((ht = ht.parentElement) && (pt = pt.parentElement)) {
                            var mt = 10;
                            if (bo(ht).top - bo(d).top > mt) break;
                            if (ht === t) break;
                            N(ht) && (dt = ht, vt = pt)
                        }
                        dt && (O = vt, d = dt, m = vt, m.bX = d, M = m.tagName), ht = null, pt = null, dt = null, vt = null
                    }
                    var gt = O ? null : d.firstElementChild;
                    if (gt) d = gt, m = m.firstElementChild, S(1);
                    else {
                        var yt;
                        while (d !== t && !(yt = d.nextElementSibling)) d = d.parentElement, m = m.parentElement, S(-1);
                        if (d === t) {
                            if (O)
                                if (O.parentElement) O.remove();
                ...
                for (var W = a.length - 1; W >= 0; --W) {
                    var bt = a[W];
                    bt.parentNode && this.dn(bt, bt.bX) && (w === bt && ((w = bt.nextElementSibling) || (w = bt.parentElement)), bt.remove())
                }
                ...
                for (var W = 0; W < wt.length; ++W) {
                    ...
                    if (!Et) {
                        var Nt = St.querySelectorAll("embed, object").length,
                            Ct = St.bX.querySelectorAll("embed, object").length;
                        !Nt && Ct && (Et = !0)
                    }
                    if (!Et) {
                        var kt = St.bX.getElementsByTagName("img"),
                            Lt = kt.length,
                            At = 0;
                ...
                if (r && !bd(n.innerText).length) return null;
                if (w) {
                    var _t = document.createElement("div"),
                        Dt = w.bX.getBoundingClientRect(),
            ...
            bU: function(t) {
                ...
                if (n && i.cC() < ds) return n;
                if (!t) {
                    if (i.bF()) return null;
                    if (i.aG()) return null;
                    if (i.bK()) return null;
                    if (i.bC(r)) return null
                }
                return i
            },
            aX: function(t) {
            ...
            bQ: function(t) {
                function n(e, t) {
                    return e.dc() !== t.dc() ? t.dc() - e.dc() : t.cW() - e.cW()
                };
                return t.sort(n)
            },
            cO: function() {
                ...
                for (var o = 0; o < i; ++o) {
                    var u = r[o];
                    if (bw[u.tagName]) continue;
                    var a = db.bI(u, this.contentDocument);
                    a && s.push(a);
                    if (Date.now() > n) {
                        s = [];
                        break
                ...
                var f = s.length;
                for (var o = 0; o < f; ++o) s[o].element.dq = s[o];
                for (var o = 0; o < f; ++o) {
                    var l = s[o];
                    if (l.element.tagName !== "BLOCKQUOTE") continue;
                    var c = l.element.parentElement.dq;
                    if (!c) continue;
                    c.ar(l)
                }
                for (var o = 0; o < f; ++o) s[o].element.dq = null;
                return s
            },
            bq: function(t) {
                function o(e, t) {
                    function u(t) {
                        ...
                        if (n) {
                            var r = n.children,
                                i = r.length;
                            for (var s = 0; s < i; ++s)
                                if (getComputedStyle(r[s]).float !== "none") return !1
                        }
                        return !0
                    };
            ...
            cQ: function() {
                ...
                for (var n = 0; n < t; ++n) delete this.bb[n].bV;
                this.bb = []
            },
            as: function() {
                this.cQ();
                ...
                for (var r = 0; r < n; r++) {
                    ...
                    for (var u = o; u; u = u.parentElement) {
                        if (u.bV) break;
                        if (ae.test(u.className)) return new db(u, this.contentDocument);
                        if (bw[u.tagName]) continue;
                        var a = u.offsetWidth,
                            f = u.offsetHeight;
                        if (!a && !f) {
                        ...
                        if (a < ba || f < ax || a * f < cX) continue;
                        var c = this.bq(u);
                        u.bV = !0, this.bb.push(u);
                        if (!c) continue;
                        if (db.aa(u) < ax) continue;
                        var h = new db(u, this.contentDocument);
                        if (h.bC()) return null;
                        if (h.aG()) return null;
                        if (h.bK()) return null;
                        if (h.cP()) continue;
        ...
        var aF = new bf(top.document);
        var article = aF.articleNode();
        return article;
    })();
    ...
    function insertByAdvenue(ad_slot) {
        ...
        if (articleLocator.hasChildNodes()) {
            var childNodes = articleLocator.childNodes,
                excludes = "br,h1,h2,h3,h4,h5,h6",
